...
// p00_5
#define IFXCFG_PORT_LED_1                       IfxPort_P00_5
#define IFXCFG_PORT_LED_1_MODE                  IfxPort_Mode_outputPushPullGeneral
#define IFXCFG_PORT_LED_1_PAD_DRIVER            IfxPort_PadDriver_cmosAutomotiveSpeed4

// p00_6
#define IFXCFG_PORT_LED_2                       IfxPort_P00_6
#define IFXCFG_PORT_LED_2_MODE                  IfxPort_Mode_outputPushPullGeneral
#define IFXCFG_PORT_LED_2_PAD_DRIVER            IfxPort_PadDriver_cmosAutomotiveSpeed4

// p00_7
#define IFXCFG_PORT_BUTTON_0                    IfxPort_P00_7
#define IFXCFG_PORT_BUTTON_0_MODE               IfxPort_Mode_inputPullUp
#define IFXCFG_PORT_BUTTON_0_PAD_DRIVER         IfxPort_PadDriver_cmosAutomotiveSpeed1


/* Generic port I/O configuration */

#define IFXCFG_P00_5_IO_CONFIG                  { &IFXCFG_PORT_LED_1, IFXCFG_PORT_LED_1_MODE, IFXCFG_PORT_LED_1_PAD_DRIVER }
#define IFXCFG_P00_6_IO_CONFIG                  { &IFXCFG_PORT_LED_2, IFXCFG_PORT_LED_2_MODE, IFXCFG_PORT_LED_2_PAD_DRIVER }
#define IFXCFG_P00_7_IO_CONFIG                  { &IFXCFG_PORT_BUTTON_0, IFXCFG_PORT_BUTTON_0_MODE, IFXCFG_PORT_BUTTON_0_PAD_DRIVER }
