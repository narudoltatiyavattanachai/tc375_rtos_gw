#ifndef FREERTOS_CONFIG_CPU1_H
#define FREERTOS_CONFIG_CPU1_H
...
/* AURIX TCxxx definitions for CPU1 */
...
#endif
#define configCPU_NR                        1  /* CPU1 specific */
#define configPROVIDE_SYSCALL_TRAP          0
#define configSYSCALL_CALL_DEPTH            2
#define configSTM                           ( ( uint32_t * ) (0xF0001000 + configCPU_NR*0x100 ) )  /* STM1 */
#define configSTM_SRC                       ( ( uint32_t * ) (0xF0038300 + configCPU_NR*0x8) )     /* STM1 SRC */
#define configSTM_CLOCK_HZ                  ( 100000000 )
#define configSTM_DEBUG                     ( 1 )
#define configCONTEXT_SRC                   ( ( uint32_t * ) 0xF0038998 )  /* CPU1 context switch SRC */

#endif /* FREERTOS_CONFIG_CPU1_H */