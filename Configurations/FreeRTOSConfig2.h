#ifndef FREERTOS_CONFIG_CPU2_H
#define FREERTOS_CONFIG_CPU2_H
...
/* AURIX TCxxx definitions for CPU2 */
...
#define configCPU_NR                        2  /* CPU2 specific */
#define configPROVIDE_SYSCALL_TRAP          0
#define configSYSCALL_CALL_DEPTH            2
#define configSTM                           ( ( uint32_t * ) (0xF0001000 + configCPU_NR*0x100 ) )  /* STM2 */
#define configSTM_SRC                       ( ( uint32_t * ) (0xF0038300 + configCPU_NR*0x8) )     /* STM2 SRC */
#define configSTM_CLOCK_HZ                  ( 100000000 )
#define configSTM_DEBUG                     ( 1 )
#define configCONTEXT_SRC                   ( ( uint32_t * ) 0xF00389A0 )  /* CPU2 context switch SRC */

#endif /* FREERTOS_CONFIG_CPU2_H */